...
public class Tools {
    ...
    public static byte[] StrToSMPPBytes(String pStr) {
        ...
        // }
        /*
         * catch (UnsupportedEncodingException ex) { System.err.println("UnsupportedEncoding on "+pStr);
    ...
    public static byte[] StrToHex(String pStr) {
        ...
        while (i < bytes.length - 1) {
            ...
            try {
                ...
                if (tmpBytes[0] >= NUMBER_MIN && tmpBytes[0] <= NUMBER_MAX) tmpBytes[0] = new Integer(tmpBytes[0]
                                                                                                      - NUMBER_KEY).byteValue();
                if (tmpBytes[0] >= UPPER_MIN && tmpBytes[0] <= UPPER_MAX) tmpBytes[0] = new Integer(tmpBytes[0]
                                                                                                    - UPPER_KEY).byteValue();
                if (tmpBytes[0] >= LOWER_MIN && tmpBytes[0] <= LOWER_MAX) tmpBytes[0] = new Integer(tmpBytes[0]
                                                                                                    - LOWER_KEY).byteValue();
                ...
                if (tmpBytes[1] >= NUMBER_MIN && tmpBytes[1] <= NUMBER_MAX) tmpBytes[1] = new Integer(tmpBytes[1]
                                                                                                      - NUMBER_KEY).byteValue();
                if (tmpBytes[1] >= UPPER_MIN && tmpBytes[1] <= UPPER_MAX) tmpBytes[1] = new Integer(tmpBytes[1]
                                                                                                    - UPPER_KEY).byteValue();
                if (tmpBytes[1] >= LOWER_MIN && tmpBytes[1] <= LOWER_MAX) tmpBytes[1] = new Integer(tmpBytes[1]
                                                                                                    - LOWER_KEY).byteValue();
    ...
    public static String HexToStr(byte[] pBytes) {
        ...
        for (int i = 0; i < pBytes.length; i++) {
            ...
            try {
                result = result + new String(strList,"GBK");
            } catch (UnsupportedEncodingException e) {
            }
